...
// Imagens de teste (simulação)
const imagensTeste = [
  "https://via.placeholder.com/300x350.png?text=Vestido+Rosa",
  "https://via.placeholder.com/300x350.png?text=Blusa+Feminina",
  "https://via.placeholder.com/300x350.png?text=Saia+Elegante",
  "https://via.placeholder.com/300x350.png?text=Calca+Feminina",
];
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
        {produtos.map((produto, index) => (
          ...
          >
            ...
            <img
              src={imagensTeste[index % imagensTeste.length]}
              alt={produto.nome}
