...
export default function Cadastro() {
  ...
  const [mensagem, setMensagem] = useState(""); // nova linha para mensagem
  ...
  async function handleCadastro(e) {
    ...
    // Validação instantânea de email no frontend
    const regex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
    if (!regex.test(email)) {
      setMensagem("Por favor, insira um email válido!"); // mostra mensagem imediatamente
      setLoading(false);
