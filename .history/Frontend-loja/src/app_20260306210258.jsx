...
import VerificarCodigo from "./pages/VerificarCodigo.jsx"; // componente para digitar código
    ...
    <Router>
          ...
          <nav className="flex flex-wrap justify-center md:justify-end gap-4 text-black font-medium">
            ...
            {!token && (
              <>
                ...
                <Link to="/verificar-codigo">Verificar Código</Link> {/* link limpo e direto */}
              </>
            )}
      ...
      <main className="bg-gray-100 min-h-screen pt-6">
        <Routes>
          ...
          {/* ROTA SEPARADA PARA DIGITAR CÓDIGO MANUAL */}
